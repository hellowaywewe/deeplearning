...
def parse_args():
    ...
    parser.add_argument('--warmup_epochs', default=40,
                        type=float, help='Every 50 epochs stores a checkpoint file. Default: 40')
    ...
    parser.add_argument('--lr', default=0.1, type=float, help='Learning rate for GPU. Default: 0.1')
...
def train():
    ...
    # Every 10 epoch to print the training log info.
    args.log_interval = args.steps_per_epoch * 10
